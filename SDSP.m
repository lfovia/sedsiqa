function [VSMap, SCMap]= SDSP(image)

% We made sufficient changes benefit to our algorithm
% ========================================================================
...
SFMap = (FinalLResult.^2 + FinalAResult.^2 + FinalBResult.^2);
% SFMap = imresize(SFMap, [oriRows, oriCols],'bilinear');
...
% SCMap = imresize(SCMap, [oriRows, oriCols],'bilinear');
